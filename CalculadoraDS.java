...
public class CalculadoraDS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtl.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        calcu.division(txtl.getText());
        txtl.setText("");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed

        calcu.multiplicacion(txtl.getText());
        txtl.setText("");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed

        calcu.suma(txtl.getText());
        txtl.setText("");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed

        txtl.setText("" + calcu.operaciones(txtl.getText()));
